...
| Square hover states | Squares the hover highlight on the left menu rows only. Everywhere else Material's own shape stands: icon buttons stay circular, and list, option and tab rows keep their radius. |
